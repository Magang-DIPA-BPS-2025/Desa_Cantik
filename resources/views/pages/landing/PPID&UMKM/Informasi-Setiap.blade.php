...
.btn-group-file .btn-file { flex: 1; text-align: center; font-size: 0.85rem; padding: 5px 0; white-space: nowrap; }
</style>
@endpush

@section('content')
<div class="container py-5">
    <h2 class="mb-4">Informasi Publik Setiap Saat</h2>

    @if($setiaps->isEmpty())
        <p class="text-muted">Belum ada informasi setiap saat.</p>
    @else
        @foreach($setiaps as $ppid)
            <div class="ppid-card">
