...
<div class="container mt-5 mb-5">
        ...
        <h2 class="fw-bold text-success">Status Permohonan Informasi Publik</h2>
        <p class="text-muted">Masukkan email Anda untuk melihat status permohonan informasi publik yang telah diajukan</p>
    </div>
            ...
            <form id="statusForm" action="{{ route('permohonan.userStatus') }}" method="GET">
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-md-3 col-sm-12">
                        <button class="btn btn-success btn-lg w-100" type="submit" id="cekStatusBtn">
