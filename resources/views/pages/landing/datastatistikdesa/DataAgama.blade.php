...
<div class="container-main">
    ...
    <div class="text-start mb-4 mt-2 px-2 gallery-header">
        ...
        <p class="text-secondary fs-5 mb-0">
            Statistik keagamaan masyarakat Desa Manggalung
        </p>
    </div>
        ...
        <div class="layout-sidebar">
            <div class="card">
                ...
                <div class="filter-content" id="filterContent">
                    <form method="GET" action="{{ route('agama') }}" class="filter-form" id="filterForm">
                        <div class="mb-3">
                        ...
                        <div class="filter-actions">
                            ...
                            @if(request('dusun') || request('tahun'))
                                <a href="{{ route('agama') }}" class="btn-reset-filter">Reset</a>
                            @endif
                        </div>
                    </form>
                </div>
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    if(total > 0 && document.querySelector("#pie-chart-Agama")){
        ...
        window.downloadChart = function(){
            chart.dataURI().then(({imgURI}) => {
                ...
                a.href = imgURI;
                a.download = "Statistik_Agama_Desa_Manggalung.png";
                a.click();
            });
        };
    } else {
...
function downloadExcel(){ 
    ...
    const wb = XLSX.utils.table_to_book(document.getElementById("tabelAgama")); 
    XLSX.writeFile(wb, "Data_Agama_Desa_Manggalung.xlsx"); 
}
...
function downloadCSV(){ 
    ...
    const wb = XLSX.utils.table_to_book(document.getElementById("tabelAgama")); 
    XLSX.writeFile(wb, "Data_Agama_Desa_Manggalung.csv"); 
}
