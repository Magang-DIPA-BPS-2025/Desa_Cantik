...
<div class="container-main">
    ...
    <div class="text-start mb-4 mt-2 px-2 gallery-header">
        ...
        <p class="text-secondary fs-5 mb-0">
            Data statistik kependudukan Desa Manggalung yang terupdate dan terperinci
        </p>
    </div>
...
document.addEventListener("DOMContentLoaded", function () {
                ...
                donut: {
                    ...
                    labels: {
                        ...
                        total: {
                            ...
                            fontFamily: "Poppins, sans-serif",
                            fontWeight: 600,
                            formatter: () => totalPenduduk.toLocaleString('id-ID')
                        }
                    }
                }
            }
    ...
    window.downloadChart = function(){
        chart.dataURI().then(({ imgURI })=>{
            ...
            a.href = imgURI;
            a.download = "Statistik_Penduduk_Desa_Manggalung.png";
            a.click();
        });
    };
});
...
function downloadCSV(){ 
    const wb = XLSX.utils.table_to_book(document.getElementById("tabelPenduduk")); 
    XLSX.writeFile(wb, "Data_Penduduk_Desa_Manggalung.csv"); 
}
