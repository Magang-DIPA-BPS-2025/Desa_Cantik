        ...
        <div class="layout-sidebar">
            <div class="card">
                ...
                <div class="filter-content" id="filterContent">
                    <form method="GET" action="{{ route('pekerjaan') }}" class="filter-form" id="filterForm">
                        <div class="mb-3">
                        ...
                        <div class="filter-actions">
                            ...
                            @if(request('dusun') || request('tahun'))
                                <a href="{{ route('pekerjaan') }}" class="btn-reset-filter">Reset</a>
                            @endif
                        </div>
                    </form>
                </div>
                ...
                <div class="chart-container">
                    ...
                    @else
                        <div class="empty-state">
                            ...
                            <h5>Tidak ada data pekerjaan</h5>
...
<script>
  ...
  document.addEventListener("DOMContentLoaded",function(){
    ...
    if(total > 0 && document.querySelector("#pie-chart-Pekerjaan")){
