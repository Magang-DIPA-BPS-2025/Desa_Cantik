...
<div class="breadcrumb" style="max-width: 1400px; margin: 20px auto; padding: 0 20px;">
  <nav style="background: #0fb000; padding: 10px 15px; border-radius: 5px;">
    <ol style="display: flex; list-style: none; margin: 0; padding: 0; gap: 10px;">
      <li><a href="{{ route('user.index') }}" style="color: #4CAF50; text-decoration: none;">Beranda</a></li>
  ...
  <div class="content">
    ...
    <div class="share-buttons" style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee;">
      ...
      <div style="display: flex; gap: 10px; flex-wrap: wrap;">
        ...
        <a href="https://twitter.com/intent/tweet?url={{ url()->current() }}&text={{ $berita->judul }}" target="_blank" style="background: #1da1f2; color: white; padding: 8px 15px; border-radius: 5px; text-decoration: none; font-size: 14px;">
          <i class="fab fa-twitter"></i> Twitter
        </a>
        <a href="https://wa.me/?text={{ urlencode($berita->judul . ' - ' . url()->current()) }}" target="_blank" style="background: #25d366; color: white; padding: 8px 15px; border-radius: 5px; text-decoration: none; font-size: 14px;">
