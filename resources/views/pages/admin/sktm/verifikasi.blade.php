...
<head>
    ...
    <title>Verifikasi Surat Keterangan Tidak Mampu</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>VERIFIKASI SURAT KETERANGAN TIDAK MAMPU</h1>
        ...
        @if($valid && isset($sktm))
            ...
            <table class="data-table">
                ...
                <tr>
                    ...
                    <td>{{ $sktm->status_verifikasi }}</td>
                </tr>
                <tr>
                    <td><strong>Tanggal Dibuat</strong></td>
                    <td>{{ $sktm->created_at->translatedFormat('d F Y') }}</td>
                </tr>
            </table>
