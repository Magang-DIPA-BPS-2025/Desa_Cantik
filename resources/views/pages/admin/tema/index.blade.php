                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('tema.create') }}" class="btn btn-primary text-white my-3">+ Tambah
                                Tema</a>
                                ...
                                <table class="table table-striped" id="table-agenda">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Thumbnail</th>
                                            <th>Judul Tema</th>
                                            <th>Judul Modul</th> <!-- Tambahkan kolom baru -->
                                            <th>Deskripsi</th>
                                            <th>Status</th>
                                            <th>Action</th>
                                        </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img class="img img-fluid" width="100"
                                                        src="{{ asset('upload/tema/' . $data->gambar) }}"
                                                        alt="Thumbnail Tema">
                                                </td>
                                                <td>{{ $data->nama ?? '-' }}</td>
                                                <td>
                                                    @if ($data->modul->isNotEmpty())
                                                        {{ $data->modul->pluck('judul')->join(', ') }}
                                                        <!-- Tampilkan semua judul modul -->
                                                    @else
                                                ...
                                                <td>
                                                    <a href="{{ route('tema.edit', $data->id) }}"
                                                        class="btn btn-warning my-2">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <button onclick="deleteData({{ $data->id }}, 'tema')"
