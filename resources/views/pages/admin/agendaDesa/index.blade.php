                        ...
                        <div class="control-bar">
                            ...
                            <div class="right-controls">
                                <div class="search-container">
                                    <input type="text" class="form-control" id="custom-search" placeholder="Cari agenda..." value="{{ request('search') }}">
                                ...
                                <tbody>
                                    @foreach ($datas as $i => $agenda)
                                        <tr>
                                            ...
                                            <td class="deskripsi-singkat" title="{{ $agenda->deskripsi }}">
                                                {{ Str::limit($agenda->deskripsi, 50) }}
                                            </td>
                                            <td>{{ $agenda->kategori }}</td>
                                            <td>
                                                <div class="action-buttons">
                                                    <a href="{{ route('AgendaDesa.edit', $agenda->id) }}" class="btn btn-warning" title="Edit">
            ...
            async function downloadPDF() {
                ...
                try {
                    ...
                    element.innerHTML = `<div style="text-align:center;margin-bottom:20px;">
                        <h2 style="margin:0;color:#333;">Data Agenda Desa</h2>
            ...
            function downloadExcel() {
                ...
                try {
                    ...
                    if (!ws['A1'].v.includes('Data Agenda Desa')) {
                        ...
                        XLSX.utils.sheet_add_aoa(ws, [['']], { origin: 'A3' }); // Baris kosong
