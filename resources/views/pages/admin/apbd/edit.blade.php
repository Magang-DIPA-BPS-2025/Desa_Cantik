                    ...
                    <form action="{{ route('apbd.update', $apbd->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="tahun" class="form-control @error('tahun') is-invalid @enderror" required>
                                ...
                                @for ($year = now()->year - 5; $year <= now()->year + 5; $year++)
                                    <option value="{{ $year }}" {{ $apbd->tahun == $year ? 'selected' : '' }}>
                                        {{ $year }}
                                    </option>
                                @endfor
                            </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="total_pendapatan"
                                           ...
                                           value="{{ old('total_pendapatan', $apbd->total_pendapatan) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="total_belanja"
                                           ...
                                           value="{{ old('total_belanja', $apbd->total_belanja) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="penerimaan"
                                           ...
                                           value="{{ old('penerimaan', $apbd->penerimaan) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="pengeluaran"
                                           ...
                                           value="{{ old('pengeluaran', $apbd->pengeluaran) }}"
                        ...
                        <div class="form-group">
                                    ...
                                    <input type="number" name="surplus_defisit"
                                           ...
                                           value="{{ old('surplus_defisit', $apbd->surplus_defisit) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="pendapatan_pad"
                                           ...
                                           value="{{ old('pendapatan_pad', $apbd->pendapatan_pad) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="pendapatan_transfer"
                                           ...
                                           value="{{ old('pendapatan_transfer', $apbd->pendapatan_transfer) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="pendapatan_lain"
                                           ...
                                           value="{{ old('pendapatan_lain', $apbd->pendapatan_lain) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="belanja_pemerintahan"
                                           ...
                                           value="{{ old('belanja_pemerintahan', $apbd->belanja_pemerintahan) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="belanja_pembangunan"
                                           ...
                                           value="{{ old('belanja_pembangunan', $apbd->belanja_pembangunan) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="belanja_pembinaan"
                                           ...
                                           value="{{ old('belanja_pembinaan', $apbd->belanja_pembinaan) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="belanja_pemberdayaan"
                                           ...
                                           value="{{ old('belanja_pemberdayaan', $apbd->belanja_pemberdayaan) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="belanja_bencana"
                                           ...
                                           value="{{ old('belanja_bencana', $apbd->belanja_bencana) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="pembiayaan_penerimaan"
                                           ...
                                           value="{{ old('pembiayaan_penerimaan', $apbd->pembiayaan_penerimaan) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="pembiayaan_pengeluaran"
                                           ...
                                           value="{{ old('pembiayaan_pengeluaran', $apbd->pembiayaan_pengeluaran) }}"
